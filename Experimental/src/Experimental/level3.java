...
public class level3<ae>{
    ...
    level3() {
        ...
        PathTransition forThanos = new PathTransition(Duration.seconds(8), path_Thanos, Thanos);
        ...
        PathTransition forUltron = new PathTransition(Duration.seconds(7), path_Ultron, Ultron);
